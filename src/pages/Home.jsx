  ...
  const products = [
    {
      ...
      description:
        "Night Hub Scotch Whisky is bold, smooth, and unforgettable — crafted for those who make the night their stage. With a refined blend of flavors, it delivers the perfect balance of strength and sophistication.",
      image: night,
    ...
    },
    {
      ...
      description:
        "Royal Legacy is our crown jewel — a premium single malt Scotch whisky crafted with time, tradition, and expertise. Every sip reflects heritage, making it perfect for true connoisseurs.",
      image: legacy,
    ...
    },
    {
      ...
      description:
        "Imperial Ultra is a whisky designed for those who celebrate in style. With a full-bodied profile and ultra-smooth finish, it embodies the perfect blend of tradition and modern refinement.",
    ...
    },
    {
      ...
      description:
        "Queen Special is a premium scotch whisky that balances grace with boldness. Smooth, flavorful, and refined — it's a whisky crafted for those who live with charm and lead with elegance.",
      image: queen,
            ...
            <div className="space-y-6">
              <div className="bg-[#6b0d37]/40 backdrop-blur-sm p-8 rounded-2xl border border-[#FFD700]/20">
                ...
                <p className="text-gray-200 leading-relaxed text-lg">
                  Established in{" "}
                  <span className="text-[#FFD700] font-bold">2018</span> and
                  coming into full-scale operations in{" "}
                  <span className="text-[#FFD700] font-bold">2021</span>, Royal
                  Supreme Distillery & Beverage Company has quickly emerged as
                  one of the fastest-growing names in India's premium alcoholic
                  beverage industry.
                </p>
              </div>
              ...
              <div className="bg-[#6b0d37]/40 backdrop-blur-sm p-8 rounded-2xl border border-[#FFD700]/20">
                ...
                <p className="text-gray-200 leading-relaxed text-lg mb-4">
                  ...
                  , whose leadership and passion for quality have been the
                  cornerstone of our success. Today, he is joined by{" "}
                  <span className="text-[#FFD700] font-bold">
                    Mr. Shubham Kumar
                  </span>
              ...
              <div className="bg-[#6b0d37]/40 backdrop-blur-sm p-8 rounded-2xl border border-[#FFD700]/20">
                ...
                <p className="text-gray-200 leading-relaxed text-lg">
                  At Royal Supreme, we believe every bottle tells a story. Each
                  product is crafted to perfection, blended with tradition, and
                  refined with modern innovation. We stand for consistency,
                  authenticity, and a promise of unparalleled taste.
                </p>
              </div>
            </div>
                  ...
                  <div className="text-sm">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={state}
                          className="bg-[#951049] text-[#FFD700] px-3 py-1 rounded-full text-xs font-bold"
                        >
                          {state}
                        </span>
                      ))}
              ...
              <div className="bg-[#6b0d37]/40 backdrop-blur-sm p-8 rounded-2xl border border-[#FFD700]/20">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-2">
                      Every product crafted to crown moments
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {[
                {
                  icon: Award,
                  title: "Trusted Vision",
                  desc: "Founded by seasoned entrepreneurs",
                },
                {
                  icon: Shield,
                  title: "Premium Quality",
                  desc: "State-of-the-art manufacturing",
                },
                {
                  icon: Wine,
                  title: "Diverse Range",
                  desc: "Catering to every palate",
                },
                {
                  icon: Award,
                ...
                },
                {
                  icon: Shield,
                  title: "Luxury Brand",
                  desc: "Symbolizing celebration",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="bg-[#6b0d37]/40 backdrop-blur-sm p-6 rounded-xl border border-[#FFD700]/20 text-center hover:bg-[#6b0d37]/60 transition-all transform hover:scale-105"
                >
          ...
          <div className="mt-20 text-center">
            <div className="max-w-3xl mx-auto bg-gradient-to-r from-[#FFD700] to-[#FFA500] p-12 rounded-3xl">
              <p className="text-2xl md:text-3xl font-bold text-[#951049] italic">
                "Royal Supreme isn't just about creating beverages — it's about
                creating experiences. Every pour is a promise, every sip a
                celebration."
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-200 max-w-2xl mx-auto">
              Discover our carefully curated selection of premium spirits, each
              crafted with uncompromising quality and heritage.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            <div className="text-center p-8 bg-[#6b0d37]/50 rounded-lg backdrop-blur-sm">
              ...
              <h3 className="text-xl font-bold text-[#FFD700] mb-2 uppercase">
                Award Winning
              </h3>
            ...
            <div className="text-center p-8 bg-[#6b0d37]/50 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-gray-300">
                {" "}
                Years of distilling tradition and expertise
              </p>
            </div>
            <div className="text-center p-8 bg-[#6b0d37]/50 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-gray-300">
                Only the finest ingredients and aging processes
              </p>
            </div>
          </div>
        </div>
